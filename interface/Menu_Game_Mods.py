...
class Game_Mods(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.blackjack_button = ttk.Button(self, text="BlackJack", command=lambda: controller.show_frame("BlackJack"))
        self.blackjack_button.place(x=407, y=343, height=28, width=287)

        self.texasholdem_button = ttk.Button(self, text="Texas Holdem", command=lambda: controller.show_frame("Game"))
        self.texasholdem_button.place(x=407, y=382, height=28, width=287)

        self.slotmachine_button = ttk.Button(self, text="Slot Machine", state="disabled")
        self.slotmachine_button.place(x=407, y=421, height=28, width=287)

        self.roulette_button = ttk.Button(self, text="Roulette", state="disabled")
