...
class Game(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.start_new_game = [
            {"name": "Catherine", "start_chips": 1000, "blind": 0, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_cathrine_label, "player": "bot", "card": [self.back_card_2_image_label_female, self.back_card_image_label_female], "player_id": '-', "player_cards": "-", "label_command": self.chips_cathrine_label_command, "label_win": (30, 450)},
            {"name": "Marco Reus", "start_chips": 1000, "blind": 1, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_marco_rues_label, "player": "bot", "card": [self.back_card_2_image_label_marco, self.back_card_image_label_marco], "player_id": '-', "player_cards": "-", "label_command": self.chips_marco_rues_label_command, "label_win": (30, 130)},
            {"name": "Crazy Stu", "start_chips": 1000, "blind": 2, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_crazy_stu_label, "player": "bot", "card": [self.back_card_2_image_label_bear, self.back_card_image_label_bear], "player_id": '-', "player_cards": "-", "label_command": self.chips_crazy_stu_label_command, "label_win": (370, 75)},
            {"name": "Mike", "start_chips": 1000, "blind": 0, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_mike_label, "player": "bot", "card": [self.back_card_2_image_label_mike, self.back_card_image_label_mike], "player_id": '-', "player_cards": "-", "label_command": self.chips_mike_label_command, "label_win": (1030, 30)},
            {"name": "Cool dog", "start_chips": 1000, "blind": 0, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_cool_dog_label, "player": "bot", "card": [self.back_card_2_image_label_dog, self.back_card_image_label_dog], "player_id": '-', "player_cards": "-", "label_command": self.chips_cool_dog_label_command, "label_win": (1045, 530)},
            {"name": self.player_name, "start_chips": self.player_chips, "blind": 0, "command": None, "active": 0, "bet": 0, "label_chips": self.chips_player_label, "player": "human", "card": [self.back_card_2_image_me_label, self.back_card_image_me_label], "player_id": '-', "player_cards": "-", "label_command": self.chips_player_label_command, "label_win": (630, 550)}
        ]
                    ...
                    if player["player"] == "human":
                        ...
                        if player["command"] == "fold":
                            ...
                            if player["blind"] == 1:
                                ...
                                if self.rise == True:
                                    for pl in self.start_new_game:
                                        if pl['command'] != 'fold' and pl["bet"] < player["bet"]:
                                            flag = True
                                    if flag == False:
                                        self.update_window()
                                        self.flop_event.set()
    ...
    def check_command(self):
        ...
        if self.start_new_game[self.player_index]["command"] == "check":
            if self.start_new_game[self.player_index]["blind"] == 1:
                self.update_window()
                self.flop_event.set()
            else:
                self.update_window()
        ...
        if self.start_new_game[self.player_index]["command"] == "call":
            ...
            for player in self.start_new_game:
                if player['bet'] < self.start_new_game[self.player_index]["bet"]:
                    flag = True
            if flag == False:
                self.update_window()
                self.flop_event.set()
